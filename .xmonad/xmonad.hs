...
myManageHook = composeAll
     ...
     , className =? "feh"            --> doShift ( myWorkspaces !! 8 )
...
myKeys =
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        ...
        , ("M-p i", spawn "rider.sh")          -- screenshots (images)
    ...
    --    , ("M-i", spawn (myTerminal ++ " -e code")) 
        , ("M-r", spawn "j4-dmenu-desktop")
        , ("M-v", spawn (myTerminal ++ " -e feh Pictures/ml-framework.png"))
    -- KB_GROUP Kill windows
        , ("M-f", kill1)     -- Kill the currently focused client
        , ("M-S-f", killAll)   -- Kill all windows on current workspace
